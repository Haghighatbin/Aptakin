...
def update_plots(k_on, k_off, T_conc, I_min, I_max, hill_n,
    ...
    fig_swv.add_trace(go.Scatter(x=[crossover_freq, crossover_freq], y=[0, 1],
                                 mode='lines', name=f'Crossover = {crossover_freq:.1f} Hz',
                                 line=dict(color='black', dash='dash')))
    fig_swv.update_layout(title='SWV Frequency Response', xaxis_title='Frequency (Hz)',
                          yaxis_title='Normalised SWV Current', template=plotly_template, font_size=16)
